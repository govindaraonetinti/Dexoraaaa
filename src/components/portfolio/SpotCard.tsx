...
export const SpotCard = ({ balance }: { balance: string }) => {
    return (
        <div className="border-2 border-[#2a2a32] overflow-hidden">
            ...
            <div className="flex justify-between items-center border-b-2 border-[#2A2A32] px-6 py-5">
                <div className="font-medium text-[20px]">Spot</div>
                <Link to={'/trade/BTC/USDC'} className="text-[16px] text-white border px-4 py-2 rounded-xl border-[#37373C] flex items-center gap-1">
            ...
            {/* Available + In Order */}
            <div className="px-3 py-3 max-w-[95%] mx-auto">
                <CardRow label="Available" value="--" />
                <CardRow label="In order" value="--" />
            </div>
