...
export default {
  ...
  plugins: [
    function ({ addUtilities }) {
      addUtilities({
        '.site-width-full': {
          '@apply px-6 md:px-0 max-w-[1900px] mx-auto': {},
        },
        '.site-width': {
          '@apply px-6 md:px-8 lg:px-24 max-w-[1700px] mx-auto': {},
        },
        '.site-width-sm': {
          '@apply px-6 md:px-8 lg:px-24 max-w-[1350px] 2xl:px-0 2xl:max-w-[1320px] mx-auto': {},
        },
        '.h1-tag': {
          '@apply text-[36px] xl:text-[52px] 2xl:text-[100px]': {},
        },
        '.h2-tag': {
          '@apply text-[48px] xl:text-[54px] 2xl:text-[70px]': {},
        },
        '.h3-tag': {
          '@apply text-[24px] sm:text-[30px] xl:text-[36px] 2xl:text-[45px]': {},
        },
        '.h4-tag': {
          '@apply text-[20px] lg:text-[26px] font-semibold leading-tight': {},
        },
        '.p-tag': {
          '@apply text-[18px] xl:text-lg 2xl:text-[24px] font-medium leading-tight': {},
        },
        '.site-x-pad': {
          '@apply px-4 xl:px-12': {},
        },
        '.s-title': {
          '@apply font-bold text-2xl xl:text-3xl m-0': {},
        },
        '.sm-title': {
          '@apply font-semibold text-lg lg:text-xl xl:text-2xl m-0': {},
        },
        '.section-gap': {
